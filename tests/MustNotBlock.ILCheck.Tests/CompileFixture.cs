...
public static class CompileFixture
{
    ...
    {
        var tempDir = Path.Combine(Path.GetTempPath(), "cgc-il-fixtures-mnb", Guid.NewGuid().ToString("N"));
        ...
        var attributesDllPath = typeof(global::CallgraphClosure.Attributes.MustNotBlockAttribute)
            .Assembly.Location;
        File.Copy(
            attributesDllPath,
    ...
    private static IEnumerable<MetadataReference> GetStandardReferences()
    {
        ...
        yield return MetadataReference.CreateFromFile(
            typeof(global::CallgraphClosure.Attributes.MustNotBlockAttribute).Assembly.Location);
    }
}
